...
import com.certiorem.microservices.application.services.impl.DriverServiceImpl;
...
public class DriverServiceImplTest {
	...
	public void testReadDriver() {
		...
		Driver entityDriver = driverService.read(1);
	...
	public void testReadDrivers() {
		...
		Mockito.when(restTemplate.exchange(DriverConstrants.DRIVER_SERVICE_CONTROLLER_HOST + DriverConstrants.DRIVER_READ_ALL, HttpMethod.GET, null,
