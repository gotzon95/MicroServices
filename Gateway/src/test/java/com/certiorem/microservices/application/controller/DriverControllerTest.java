...
public class DriverControllerTest {
	...
	public void testReadDriver() throws Exception {
		Mockito.when(driverService.read(Mockito.anyInt())).thenReturn(driver);
	...
	public void testReadDrivers() throws Exception {
		...
		drivers.add(driver);
		Mockito.when(driverService.readAll()).thenReturn(drivers);
	...
	public void testDeleteDriver() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/driver/delete?id=1")
				.accept(MediaType.APPLICATION_JSON);
