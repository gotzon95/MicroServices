...
public class TeamServiceImplTest {
	...
	public void testReadTeam() {
		...
		Team entityTeam = teamService.read(1);
	...
	public void testReadTeams() {
		...
		Mockito.when(restTemplate.exchange(TeamConstrants.TEAM_SERVICE_CONTROLLER_HOST + TeamConstrants.TEAM_READ_ALL, HttpMethod.GET, null,
