...
public class DriverServiceImpl implements DriverService{
	...
	public Driver readDriver(Integer driverId) {
		...
		ResponseEntity<Driver> responseEntity = restTemplate.getForEntity(DriverConstrants.DRIVER_SERVICE_GET_DRIVER,
	...
	public List<Driver> readDrivers() {
		ResponseEntity<List<Driver>> response = restTemplate.exchange(DriverConstrants.DBB_CONNECTOR_CALL_DRIVER,
	...
	public void delete(Integer driverId) {
		...
		restTemplate.delete(DriverConstrants.DBB_CONNECTOR_DELETE_DRIVER, uriVariables);
	}
