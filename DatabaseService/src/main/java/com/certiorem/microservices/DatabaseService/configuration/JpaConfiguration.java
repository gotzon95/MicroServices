package com.certiorem.microservices.DatabaseService.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.certiorem.microservices",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.certiorem.microservices" });
