...
@WebMvcTest(value = TeamServiceController.class, secure = false)
public class TeamServiceControllerTest {
	...
	public void testReadTeam() throws Exception {
		Mockito.when(teamService.readTeam(Mockito.anyInt())).thenReturn(team);
	...
	public void testReadTeams() throws Exception {
		teams = new ArrayList<>();
		teams.add(team);
		Mockito.when(teamService.readTeams()).thenReturn(teams);
	...
	public void testDeleteTeam() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/team/delete?id=1")
				.accept(MediaType.APPLICATION_JSON);
